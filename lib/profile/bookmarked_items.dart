...
class _BookmarkedItemsState extends State<BookmarkedItems> {
  ...
  AnimationConfiguration bookMarkedCarList(int index, double _w,
      List<QueryDocumentSnapshot<Object>> bookmarked, BuildContext context) {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (ctx) => CarDetail(
                                      ...
                                      type: bookmarked[index]['type'],
                                      itemType: bookmarked[index]['itemType'],
                                      itemID: bookmarked[index]['itemID'],
                                      price: bookmarked[index]['price'],
                                      image: bookmarked[index]['image'],
                                      description: bookmarked[index]
                                          ['description'],
                                      location: bookmarked[index]['location'],
                                      title: bookmarked[index]['title'],
                                      year: bookmarked[index]['year'],
                                      capacity: bookmarked[index]['capacity'],
                                      color: bookmarked[index]['color'],
                                      condition: bookmarked[index]['condition'],
                                      exchangePossible: bookmarked[index]
                                          ['exchangePossible'],
                                      fuel: bookmarked[index]['fuel'],
                                      make: bookmarked[index]['make'],
                                      mileage: bookmarked[index]['mileage'],
                                      transmission: bookmarked[index]
                                          ['transmission'],
                                      isFavorite: !_isLiked,
                                    ),
                                  ),
  ...
  AnimationConfiguration bookMarkedHouseList(int index, double _w,
      List<QueryDocumentSnapshot<Object>> bookmarked, BuildContext context) {
    return AnimationConfiguration.staggeredGrid(
      position: index,
      duration: const Duration(milliseconds: 500),
                                  ...
                                  MaterialPageRoute(
                                    builder: (ctx) => HouseDetail(
                                      ...
                                      description: bookmarked[index]
                                          ['description'],
                                      title: bookmarked[index]['title'],
                                      area: bookmarked[index]['area'],
                                      facility: bookmarked[index]['facility'],
                                      type: bookmarked[index]['type'],
                                      price: numberFormat
                                          .format(bookmarked[index]['price'])
                                          .toString(),
                                      location: bookmarked[index]['location'],
                                      isFavorite: bookmarked[index]
                                          ['isFavorite'],
                                    ),
                                  ),
                                );
