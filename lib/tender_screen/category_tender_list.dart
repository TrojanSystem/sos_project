...
class CategoryTenderNewsList extends StatefulWidget {
  CategoryTenderNewsList({this.categoryNews});
  List categoryNews;
  @override
  State<CategoryTenderNewsList> createState() => _CategoryTenderNewsListState();
}

class _CategoryTenderNewsListState extends State<CategoryTenderNewsList>
        ...
        itemBuilder: (context, int index) {
          return GestureDetector(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (ctx) => CategoryTenderNewsList(
