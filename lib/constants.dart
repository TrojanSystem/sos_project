...
const storageTitles = TextStyle(
  fontFamily: 'FjallaOne',
  fontSize: 30,
  fontWeight: FontWeight.w900,
);
const storageItemNames = TextStyle(
  fontSize: 20,
  fontWeight: FontWeight.w900,
);
const storageItemQuantitys = TextStyle(
  fontFamily: 'FjallaOne',
  fontSize: 25,
  fontWeight: FontWeight.w900,
);
const storageItemDates = TextStyle(
  fontSize: 15,
  color: Colors.black,
);
const sloganStyls = TextStyle(
  fontFamily: 'FjallaOne',
  fontSize: 18,
  color: Colors.white,
  letterSpacing: 1,
...
const storageItemMoneys = TextStyle(
  fontFamily: 'FjallaOne',
  fontSize: 18,
  color: Colors.white,
  letterSpacing: 1,
...
const storageItemCurrencys = TextStyle(
  fontSize: 18,
  color: Colors.black,
  letterSpacing: 1,
  fontWeight: FontWeight.w900,
);
const dailyIncomeStyle = TextStyle(
...
const kkDropDowns = TextStyle(
  color: Colors.white,
  fontWeight: FontWeight.w900,
);
const kkSummaryIncomes = TextStyle(
  color: Colors.green,
  fontWeight: FontWeight.w900,
  fontSize: 18,
);
const kkSummaryExpenses = TextStyle(
  color: Colors.red,
  fontWeight: FontWeight.w900,
  fontSize: 18,
);
const kkSummaryStyles = TextStyle(
  color: Colors.black,
  fontWeight: FontWeight.w900,
  fontSize: 40,
);
const kkSummaryIncomeStyles = TextStyle(
  color: Colors.green,
  fontWeight: FontWeight.w900,
  fontSize: 20,
);
